...
{\includegraphics[height=2.5cm]{BILDER/logo.png}} \\ \vspace{3cm}
	\begin{center}
		\textsf{ \Huge{\textbf{Hausarbeit}}}\\ \vspace{1.5cm}
		\textsf{ \Huge{zu dem Thema}} \vspace{1.5cm}
			\begin{center}
				\textsf{ \Huge{\textbf{Vorlage zur Erstellung einer Hausarbeit im Fach CL}}}
			\end{center}
