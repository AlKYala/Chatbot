...
\textsf{{\large
\begin{tabular}{ccc}
	\parbox{6cm}{Julia Roegner} & \parbox{5,2cm}{\textcolor[rgb]{1,1,1}{Hallo}} & \parbox{6cm}{\raggedleft Ali Kemal Yalama} \\
	\parbox{6cm}{E-Mail: s2juroeg@uni-trier.de} & \parbox{5,2cm}{\textcolor[rgb]{1,1,1}{Hallo}} & \parbox{6cm}{\raggedleft E-Mail: s2alyala@uni-trier.de} \\
\end{tabular}
}}
\newpage
...
%\include{INHALT/HAUPT/Ali}
\include{INHALT/HAUPT/InstallationAugusta}
\include{INHALT/HAUPT/ChatScriptGrundlagen}
\include{INHALT/HAUPT/AugustaProgrammlogik}
\include{INHALT/HAUPT/DBuEinbindung}
\include{INHALT/HAUPT/Benutzerschnittstelle}
\include{INHALT/HAUPT/Probleme}
%\include{INHALT/Fazit}


\backmatter					% Anhang

\include{INHALT/ANHANG/Beispieldialog}
\include{INHALT/ANHANG/UsabilityTesting}
