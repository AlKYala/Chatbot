...
create table Artikel(
	...
	Beschreibung varchar(500), Ausfuehrung varchar(30),Groesse varchar(15), queried int,
	primary key(Artnr),
	check(Preis >= 0),
	check(queried >= 0)
);
...
-- Inhalte
  ...
  insert into Artikel values ('005A0400', 'Einkaufschip', 'Alltag', 1.00, 'Blauer Einkaufschip mit dem Siegel der Universität auf der einen und dem Logo auf der anderen Seite. Passend fuer Einkaufswagen, die ein 1-Euro-Stueck benoetigen.', 'blau', null);
  insert into Artikel values ('006A0430', 'Kaffeetasse', 'Alltag', 7.00, 'Mit Siegel in Weiss. Dunkelblau, Steinzeug, Matt-Finish Oberfläche, Roubill-Bodenmarke', 'blau', '300 ml');
  insert into Artikel values ('007A0530', 'Kaffeetasse', 'Alltag', 7.00, 'Mit Siegel in Weiss. Gruen, Steinzeug, Matt-Finish Oberfläche, Roubill-Bodenmarke', 'gruen', '300 ml');
  ...
  insert into Artikel values ('014A0400', 'Baumwolltasche', 'Alltag', 2.00, 'Koenigsblau, Siebdruck, ca. 38x42 cm. 100% Baumwolle, Innennähte verkettelt', 'blau', null);
  insert into Artikel values ('015U0412', 'Schultertasche', 'Uni', 15.00, 'Verstellbarer Schultergurt, Netztasche mit Zip innen, Fassungsvermoegen: 12 Ltr, 40x30x10, Farbe: blau', 'blau', '12 l');
  ...
  insert into Artikel values ('017A0000', 'Magnet mit Kunstsiebdruck', 'Alltag', 3.50, 'Kunstmagnet der Kuenstlerin Anja Streese, Groesse: 120x54 mm, Motiv: Universitätsbibliothek und Porta Nigra.', null, null);
  ...
  insert into Artikel values ('021K042S', 'Kapuzensweatshirt Unisex', 'Kleidung', 25.00, 'Logo gestickt, grosser Siegel-Aufdruck auf dem Ruecken.', 'blau', 'XS');
  insert into Artikel values ('022K041S', 'Kapuzensweatshirt Unisex', 'Kleidung', 25.00, 'Logo gestickt, grosser Siegel-Aufdruck auf dem Ruecken.', 'blau', 'S');
  insert into Artikel values ('023K041M', 'Kapuzensweatshirt Unisex', 'Kleidung', 25.00, 'Logo gestickt, grosser Siegel-Aufdruck auf dem Ruecken.', 'blau', 'M');
  insert into Artikel values ('024K041L', 'Kapuzensweatshirt Unisex', 'Kleidung', 25.00, 'Logo gestickt, grosser Siegel-Aufdruck auf dem Ruecken.', 'blau', 'L');
  insert into Artikel values ('025K042L', 'Kapuzensweatshirt Unisex', 'Kleidung', 25.00, 'Logo gestickt, grosser Siegel-Aufdruck auf dem Ruecken.', 'blau', 'XL');
  insert into Artikel values ('026K043L', 'Kapuzensweatshirt Unisex', 'Kleidung', 25.00, 'Logo gestickt, grosser Siegel-Aufdruck auf dem Ruecken.', 'blau', 'XXL');
  insert into Artikel values ('027K062S', 'Kapuzensweatshirt Unisex', 'Kleidung', 25.00, 'Logo gestickt, grosser Siegel-Aufdruck in blau auf dem Ruecken.', 'grau', 'XS');
  insert into Artikel values ('028K061S', 'Kapuzensweatshirt Unisex', 'Kleidung', 25.00, 'Logo gestickt, grosser Siegel-Aufdruck in blau auf dem Ruecken.', 'grau', 'S');
  insert into Artikel values ('029K061M', 'Kapuzensweatshirt Unisex', 'Kleidung', 25.00, 'Logo gestickt, grosser Siegel-Aufdruck in blau auf dem Ruecken.', 'grau', 'M');
  insert into Artikel values ('030K061L', 'Kapuzensweatshirt Unisex', 'Kleidung', 25.00, 'Logo gestickt, grosser Siegel-Aufdruck in blau auf dem Ruecken.', 'grau', 'L');
  insert into Artikel values ('031K062L', 'Kapuzensweatshirt Unisex', 'Kleidung', 25.00, 'Logo gestickt, grosser Siegel-Aufdruck in blau auf dem Ruecken.', 'grau', 'XL');
  insert into Artikel values ('032K063L', 'Kapuzensweatshirt Unisex', 'Kleidung', 25.00, 'Logo gestickt, grosser Siegel-Aufdruck in blau auf dem Ruecken.', 'grau', 'XXL');
  insert into Artikel values ('033K042S', 'Kapuzenjacke Unisex', 'Kleidung', 28.00, 'Logo gestickt, grosser Siegel-Aufdruck in weiss auf dem Ruecken. Reissverschluss vorne.', 'blau', 'XS');
  insert into Artikel values ('034K041S', 'Kapuzenjacke Unisex', 'Kleidung', 28.00, 'Logo gestickt, grosser Siegel-Aufdruck in weiss auf dem Ruecken. Reissverschluss vorne.', 'blau', 'S');
  insert into Artikel values ('035K041M', 'Kapuzenjacke Unisex', 'Kleidung', 28.00, 'Logo gestickt, grosser Siegel-Aufdruck in weiss auf dem Ruecken. Reissverschluss vorne.', 'blau', 'M');
  insert into Artikel values ('036K041L', 'Kapuzenjacke Unisex', 'Kleidung', 28.00, 'Logo gestickt, grosser Siegel-Aufdruck in weiss auf dem Ruecken. Reissverschluss vorne.', 'blau', 'L');
  insert into Artikel values ('037K042L', 'Kapuzenjacke Unisex', 'Kleidung', 28.00, 'Logo gestickt, grosser Siegel-Aufdruck in weiss auf dem Ruecken. Reissverschluss vorne.', 'blau', 'XL');
  insert into Artikel values ('038K043L', 'Kapuzenjacke Unisex', 'Kleidung', 28.00, 'Logo gestickt, grosser Siegel-Aufdruck in weiss auf dem Ruecken. Reissverschluss vorne.', 'blau', 'XXL');
  insert into Artikel values ('039K062S', 'Kapuzenjacke Unisex', 'Kleidung', 28.00, 'Logo gestickt, grosser Siegel-Aufdruck in blau auf dem Ruecken. Reissverschluss vorne.', 'grau', 'XS');
  insert into Artikel values ('040K061S', 'Kapuzenjacke Unisex', 'Kleidung', 28.00, 'Logo gestickt, grosser Siegel-Aufdruck in blau auf dem Ruecken. Reissverschluss vorne.', 'grau', 'S');
  insert into Artikel values ('041K061M', 'Kapuzenjacke Unisex', 'Kleidung', 28.00, 'Logo gestickt, grosser Siegel-Aufdruck in blau auf dem Ruecken. Reissverschluss vorne.', 'grau', 'M');
  insert into Artikel values ('042K061L', 'Kapuzenjacke Unisex', 'Kleidung', 28.00, 'Logo gestickt, grosser Siegel-Aufdruck in blau auf dem Ruecken. Reissverschluss vorne.', 'grau', 'L');
  insert into Artikel values ('043K062L', 'Kapuzenjacke Unisex', 'Kleidung', 28.00, 'Logo gestickt, grosser Siegel-Aufdruck in blau auf dem Ruecken. Reissverschluss vorne.', 'grau', 'XL');
  insert into Artikel values ('044K063L', 'Kapuzenjacke Unisex', 'Kleidung', 28.00, 'Logo gestickt, grosser Siegel-Aufdruck in blau auf dem Ruecken. Reissverschluss vorne.', 'grau', 'XXL');
  insert into Artikel values ('045K011S', 'Herrenshirt', 'Kleidung', 13.00, 'Schwarzes Shirt mit weissem Siegel-Aufdruck auf der linken Seite. Auf dem rechten Aermel: weisser Schriftzug der Universität.', 'schwarz', 'S');
  insert into Artikel values ('046K011M', 'Herrenshirt', 'Kleidung', 13.00, 'Schwarzes Shirt mit weissem Siegel-Aufdruck auf der linken Seite. Auf dem rechten Aermel: weisser Schriftzug der Universität.', 'schwarz', 'M');
  insert into Artikel values ('047K011L', 'Herrenshirt', 'Kleidung', 13.00, 'Schwarzes Shirt mit weissem Siegel-Aufdruck auf der linken Seite. Auf dem rechten Aermel: weisser Schriftzug der Universität.', 'schwarz', 'L');
  insert into Artikel values ('048K012L', 'Herrenshirt', 'Kleidung', 13.00, 'Schwarzes Shirt mit weissem Siegel-Aufdruck auf der linken Seite. Auf dem rechten Aermel: weisser Schriftzug der Universität.', 'schwarz', 'XL');
  insert into Artikel values ('049K012S', 'Damenshirt', 'Kleidung', 13.00, 'Schwarzes Shirt mit weissem Siegel-Aufdruck auf der linken Seite. Auf dem rechten Aermel: weisser Schriftzug der Universität.', 'schwarz', 'XS');
  insert into Artikel values ('050K011S', 'Damenshirt', 'Kleidung', 13.00, 'Schwarzes Shirt mit weissem Siegel-Aufdruck auf der linken Seite. Auf dem rechten Aermel: weisser Schriftzug der Universität.', 'schwarz', 'S');
  insert into Artikel values ('051K011M', 'Damenshirt', 'Kleidung', 13.00, 'Schwarzes Shirt mit weissem Siegel-Aufdruck auf der linken Seite. Auf dem rechten Aermel: weisser Schriftzug der Universität.', 'schwarz', 'M');
  insert into Artikel values ('052K011L', 'Damenshirt', 'Kleidung', 13.00, 'Schwarzes Shirt mit weissem Siegel-Aufdruck auf der linken Seite. Auf dem rechten Aermel: weisser Schriftzug der Universität.', 'schwarz', 'L');
  insert into Artikel values ('053K012L', 'Damenshirt', 'Kleidung', 13.00, 'Schwarzes Shirt mit weissem Siegel-Aufdruck auf der linken Seite. Auf dem rechten Aermel: weisser Schriftzug der Universität.', 'schwarz', 'XL');
  insert into Artikel values ('054B0D00', 'Geschichte der Universität Trier', 'Buch', 15.00, 'Das vorliegende Buch berichtet ausfuehrlich ueber die Geschichte der Universität Trier. Mit 49 farbigen Abbildungen und 25 Bilder in Schwarz/Weiss. 328 Seiten', 'Deutsch', null);
  insert into Artikel values ('055B0E00', 'Geschichte der Universität Trier', 'Buch', 15.00, 'Das vorliegende Buch berichtet ausfuehrlich ueber die Geschichte der Universität Trier. Mit 49 farbigen Abbildungen und 25 Bilder in Schwarz/Weiss. 328 Seiten', 'Englisch', null);
  insert into Artikel values ('056B0F00', 'Geschichte der Universität Trier', 'Buch', 15.00, 'Das vorliegende Buch berichtet ausfuehrlich ueber die Geschichte der Universität Trier. Mit 49 farbigen Abbildungen und 25 Bilder in Schwarz/Weiss. 328 Seiten', 'Franzoesisch', null);
  insert into Artikel values ('057B0C00', 'Geschichte der Universität Trier', 'Buch', 15.00, 'Das vorliegende Buch berichtet ausfuehrlich ueber die Geschichte der Universität Trier. Mit 49 farbigen Abbildungen und 25 Bilder in Schwarz/Weiss. 328 Seiten', 'Chinesisch', null);
  ...
  insert into Artikel values ('060B0F00', 'Trier fuer Anfänger', 'Buch', 7.00, 'Dieses kleine Buechlein ist ein Muss, fuer alle, die Trier zum ersten Mal erleben. Sehenswuerdigkeiten und Geschichte werden anhand von Abbildungen näher beschrieben.', 'Franzoesisch', null);
  insert into Artikel values ('061B0D00', 'Mordsstimmung', 'Buch', 9.99, 'An der Universtität in Trier wurde ein Student tot aufgefunden. War es ein Unfall oder Mord? Kommissar Voelxen ermittelt mit Humor und Ortskenntnis in einem Fall, in dem nichts so ist, wie es scheint.', 'Deutsch', null );
 ...
 -- Moegliche Kategorien: Alltag, Schreibwaren,  EssenTrinken, Accessoire, Unterhaltung
...
where queried = 0 and --gehe davon aus dass queried 0 ist.
...
natural join anwendung
where queried = 0
and case when $things is not null then name else 'NULLVALUE' end 
